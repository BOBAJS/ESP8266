...
#define Z80_RAM_SIZE  1*1024 // 1K
#define Z80_RAM_BASE  0x4000

/*
static const unsigned char zx80rom[] PROGMEM = {
...
*/
static const unsigned char zx81rom[] PROGMEM = {
...
class ZX81 {
  public:
    ...
    void reset();
    void run();
    void setLCD(ILI9163 *setLCD);

    void setKey(unsigned char, unsigned char, unsigned char);
    void resetKey(unsigned char);
    void putKeyboard(unsigned char, unsigned char, unsigned char);

    // Debug 
    void GetASM();
    void ShowMEM( unsigned int pos );
    void debug();
    ...
    unsigned char readPort( unsigned char reg, unsigned int port );
    void writePort( unsigned int, unsigned char );

    void updateScreen(void);
    void showScreen(void);

  private:
    unsigned char ram_[Z80_RAM_SIZE];         // RAM
    unsigned char screen_[25][32];            // Screen 
    unsigned char keyboard[9];                // keyboard state
    unsigned char keyboardbuffer[9];          // keyboard state
    unsigned char posbuffer;
